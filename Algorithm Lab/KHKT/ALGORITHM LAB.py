...
icon = pygame.image.load('KHKT/Image/logo - Copy.png')
...
pygame.display.set_caption('Algorithm Lab')

# Text
copy_message_font = pygame.font.Font('KHKT/Font/ClearSans-Bold.ttf',40)
number_message_font = pygame.font.Font('KHKT/Font/ClearSans-Bold.ttf',40)
number_message_end_font = pygame.font.Font('KHKT/Font/ClearSans-Bold.ttf',100)
font_for_finding_game = pygame.font.Font('KHKT/Font/ClearSans-Bold.ttf',60)

# Image
background = pygame.image.load('KHKT/Image/backgroundmenu.jpg')

sortmenu_background = pygame.image.load('KHKT/Image/sortmenu.jpg')
quicksort_image = pygame.image.load('KHKT/Image/quicksort1.jpg')
heapsort_image = pygame.image.load('KHKT/Image/heapsort1.jpg')
mergesort_image = pygame.image.load('KHKT/Image/mergesort1.jpg')
bubblesort_image = pygame.image.load('KHKT/Image/bubblesort1.jpg')
cocktailsort_image = pygame.image.load('KHKT/Image/cocktailsort1.jpg')
insertionsort_image = pygame.image.load('KHKT/Image/insertionsort1.jpg')

searchmenu_background = pygame.image.load('KHKT/Image/searchmenu.jpg')
binarysearch_image = pygame.image.load('KHKT/Image/binarysearch1.jpg')
sequentialsearch_image = pygame.image.load('KHKT/Image/sequentialsearch1.jpg')
jumpsearch_image = pygame.image.load('KHKT/Image/jumpsearch1.jpg')
interpolationsearch_image = pygame.image.load('KHKT/Image/interpolationsearch1.jpg')
bfs_image = pygame.image.load('KHKT/Image/bfs1.jpg')
dfs_image = pygame.image.load('KHKT/Image/dfs1.jpg')

sortgamemenu = pygame.image.load('KHKT/Image/wining.jpg')
sortgamemainmenu = pygame.image.load('KHKT/Image/sortgamemainmenu.jpg')
sortgameplay = pygame.image.load('KHKT/Image/sortgameplaymenu.jpg')

findinggame_image = pygame.image.load('KHKT/Image/findinggame_select_mode.jpg')
finding_gameplay_bot = pygame.image.load('KHKT/Image/finding_gameplay_bot.jpg')
finding_gameplay_player = pygame.image.load('KHKT/Image/finding_gameplay_player.jpg')

help_image_1 = pygame.image.load('KHKT/Image/help1.jpg')
help_image_2 = pygame.image.load('KHKT/Image/help2.jpg')
help_image_3 = pygame.image.load('KHKT/Image/help3.jpg')
help_image_4 = pygame.image.load('KHKT/Image/help4.jpg')
help_image_5 = pygame.image.load('KHKT/Image/help5.jpg')

# Buttons
sort_button = pygame.Rect(120,360,320,150)
search_button = pygame.Rect(620,360,320,150)
...
back_button = pygame.Rect(25,514,100,50)
...
while run:
    ...
    if quicksort_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Sort/quicksort.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
                ...
                if mouse_box.colliderect(length_button):
                    write_length = True
                    input_text_print = ''

                if mouse_box.colliderect(slow_button):
                    write_slow = True
                    input_text_print2 = ''
            
            if write_length == True:
                if event.type == pygame.KEYDOWN and len(input_text) <= 3:
            ...
            if write_slow == True:
                if event.type == pygame.KEYDOWN and len(input_text2) <= 3:
                    if event.key == pygame.K_RETURN:  # Nhấn Enter để kết thúc
        ...
        if key[pygame.K_RIGHT]:
            quicksort_image = pygame.image.load('KHKT/Image/quicksort2.jpg')
    ...
    if bubblesort_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(show_parameter):
                    ...
                    plt.title("Mảng đã được sắp xếp")
                    plt.bar(range(len(sorted_arr)),array,color = "lime")
                    plt.ioff()
                    plt.show()
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Sort/bubblesort.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            bubblesort_image = pygame.image.load('KHKT/Image/bubblesort2.jpg')
        elif key[pygame.K_LEFT]:
            bubblesort_image = pygame.image.load('KHKT/Image/bubblesort1.jpg')
    ...
    if mergesort_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Sort/mergesort.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            mergesort_image = pygame.image.load('KHKT/Image/mergesort2.jpg')
        elif key[pygame.K_LEFT]:
            mergesort_image = pygame.image.load('KHKT/Image/mergesort1.jpg') 
    ...
    if heapsort_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Sort/heapsort.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            heapsort_image = pygame.image.load('KHKT/Image/heapsort2.jpg')
        elif key[pygame.K_LEFT]:
            heapsort_image = pygame.image.load('KHKT/Image/heapsort1.jpg')
    ...
    if insertionsort_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Sort/insertionsort.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            insertionsort_image = pygame.image.load('KHKT/Image/insertionsort2.jpg')
        elif key[pygame.K_LEFT]:
            insertionsort_image = pygame.image.load('KHKT/Image/insertionsort1.jpg')
    ...
    if cocktailsort_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Sort/cocktailsort.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            cocktailsort_image = pygame.image.load('KHKT/Image/cocktailsort2.jpg')
        elif key[pygame.K_LEFT]:
            cocktailsort_image = pygame.image.load('KHKT/Image/cocktailsort1.jpg') 
    ...
    if sortgame_menu_end == True:
        ...
        if int(score_player) >= int(score_bot):
            ending_screen = pygame.image.load('KHKT/Image/wining.jpg')
        else:
            ending_screen = pygame.image.load('KHKT/Image/losing.jpg')
    ...
    if interpolationsearch_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(show_parameter):
                    ...
                    arr = np.random.choice(np.arange(1,50+1),size=size_arr,replace=False)
                    target = random.choice(arr)
                    arr.sort()
                    plt.ion()
                    result = interpolation_search(arr=arr,target=target,speed=speed)
                    if result != -1:
                        show_parameter_search(arr=arr,highlight=[result],highlight_color=['lime'],target=target,speed=speed)
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Search/interpolationsearch.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            interpolationsearch_image = pygame.image.load('KHKT/Image/interpolationsearch2.jpg')
        elif key[pygame.K_LEFT]:
            interpolationsearch_image = pygame.image.load('KHKT/Image/interpolationsearch1.jpg')
    ...
    if binarysearch_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(show_parameter):
                    ...
                    arr.sort()
                    plt.ion()
                    result = binary_search(arr=arr,target=target,speed=speed)
                    if result != -1:
                        show_parameter_search(arr=arr,highlight=[result],highlight_color=['lime'],target=target,speed=speed)
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Search/binarysearch.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            binarysearch_image = pygame.image.load('KHKT/Image/binarysearch2.jpg')
        elif key[pygame.K_LEFT]:
            binarysearch_image = pygame.image.load('KHKT/Image/binarysearch1.jpg')
    ...
    if sequentialsearch_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(show_parameter):
                    ...
                    arr.sort()
                    plt.ion()
                    result = sequential_search(arr=arr,target=target,speed=speed)
                    if result != -1:
                        show_parameter_search(arr=arr,highlight=[result],highlight_color=['lime'],target=target,speed=speed)
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Search/sequentialsearch.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            sequentialsearch_image = pygame.image.load('KHKT/Image/sequentialsearch2.jpg')
        elif key[pygame.K_LEFT]:
            sequentialsearch_image = pygame.image.load('KHKT/Image/sequentialsearch1.jpg')
    ...
    if jumpsearch_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(show_parameter):
                    ...
                    arr.sort()
                    plt.ion()
                    result = jump_search(arr=arr,target=target,speed=speed)
                    if result != -1:
                        show_parameter_search(arr=arr,highlight=[result],highlight_color=['lime'],target=target,speed=speed)
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    # Đọc nội dung tệp
                    with open('KHKT/Text/Search/jumpsearch.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            jumpsearch_image = pygame.image.load('KHKT/Image/jumpsearch2.jpg')
        elif key[pygame.K_LEFT]:
            jumpsearch_image = pygame.image.load('KHKT/Image/jumpsearch1.jpg')
    ...
    if bfs_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    with open('KHKT/Text/Search/bfs.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            bfs_image = pygame.image.load('KHKT/Image/bfs2.jpg')
        elif key[pygame.K_LEFT]:
            bfs_image = pygame.image.load('KHKT/Image/bfs1.jpg')
    ...
    if dfs_menu == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_box.colliderect(copy_button):
                    ...
                    with open('KHKT/Text/Search/dfs.txt', 'r', encoding='utf-8') as file:
                        content = file.read()
        ...
        key = pygame.key.get_pressed()
        if key[pygame.K_RIGHT]:
            dfs_image = pygame.image.load('KHKT/Image/dfs2.jpg')
        elif key[pygame.K_LEFT]:
            dfs_image = pygame.image.load('KHKT/Image/dfs1.jpg')
